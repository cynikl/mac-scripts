#!/bin/bash
# <https://kpumuk.info/mac-os-x/how-to-show-ssh-host-name-on-the-iterms-background/>
...
FG_COLOR="#ff5454"       # Foreground color
...
# Font path
FONT="$HOME/Library/Fonts/myriad-set-pro_semibold.ttf"
